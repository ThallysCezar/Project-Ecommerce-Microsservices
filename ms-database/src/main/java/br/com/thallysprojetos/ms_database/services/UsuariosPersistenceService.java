...
public class UsuariosPersistenceService {
    ...
    public Optional<Usuarios> findByEmail(String email) {
        return usuariosRepository.findByEmail(email); // Assumindo que este método existe no seu Repositório
    }
    ...
    public Usuarios save(Usuarios usuario) {
        // Usado para operações de CREATE e para salvar novas entidades mapeadas do RabbitMQ
