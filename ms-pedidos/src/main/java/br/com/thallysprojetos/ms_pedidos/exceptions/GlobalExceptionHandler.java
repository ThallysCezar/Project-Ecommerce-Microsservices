...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleFeignNotFoundException(FeignException.NotFound ex, HttpServletRequest request) {
        ...
        return buildErrorResponse(new PedidosNotFoundException(message), request, HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<ErrorMessage> handleFeignBadRequest(FeignException.BadRequest ex, HttpServletRequest request) {
        ...
        String message = "Requisição inválida ao buscar pedido";
    ...
    public ResponseEntity<ErrorMessage> handleNotFoundException(PedidosNotFoundException ex, HttpServletRequest request) {
        log.warn("Pedido não encontrado: {}", ex.getMessage());
        return buildErrorResponse(ex, request, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(PedidosAlreadyExistException.class)
    public ResponseEntity<ErrorMessage> handleAlreadyExistException(PedidosAlreadyExistException ex, HttpServletRequest request) {
        log.warn("Pedido já existe: {}", ex.getMessage());
        return buildErrorResponse(ex, request, HttpStatus.CONFLICT);
    }

    @ExceptionHandler(PedidosException.class)
    public ResponseEntity<ErrorMessage> handlePedidosException(PedidosException ex, HttpServletRequest request) {
